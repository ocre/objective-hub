...
export const translations = {
  en: {
    ...
    notificationsSupported: 'Notification support',
    notificationTitle: 'Task Reminder',
    remindMeLater: 'Remind me later',
    snooze10Min: 'Snooze 10m',
    snoozeDurationLabel: 'Snooze Duration',
    snoozeDurationDesc: 'Default delay duration when selecting "Remind me later".',
    minutesUnit: 'minutes',
    ...
    archivedDesc: 'Archived and locked (cannot be edited or deleted)',
  ...
  zh: {
    ...
    notificationsSupported: '系统通知支持',
    notificationTitle: '任务到期提醒',
    remindMeLater: '稍后提醒我',
    snooze10Min: '延迟10分钟',
    snoozeDurationLabel: '稍后提醒延迟时间',
    snoozeDurationDesc: '点击“稍后提醒我”时的默认延迟时间。',
    minutesUnit: '分钟',
